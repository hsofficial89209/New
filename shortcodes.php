...
add_shortcode('property_submission_form', function() {
    ...
    <div class="container my-4">
        <form id="repm-property-form" enctype="multipart/form-data" class="needs-validation" novalidate>
              ...
              <!-- Step 1: Key Details -->
                    <div class="repm-step repm-card" data-step="1">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="for_sale_rent" class="form-select" required>
                    ...
                    <div class="mb-3" id="commercial-type-wrap">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <?php foreach (range(1,5) as $i): ?>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="bedrooms" id="bedrooms<?php echo $i; ?>" value="<?php echo $i; ?>" required>
                                        <label class="form-check-label" for="bedrooms<?php echo $i; ?>"><?php echo $i; ?></label>
                                    </div>
                                <?php endforeach; ?>
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <?php foreach (range(1,3) as $i): ?>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="bathrooms" id="bathrooms<?php echo $i; ?>" value="<?php echo $i; ?>" required>
                                        <label class="form-check-label" for="bathrooms<?php echo $i; ?>"><?php echo $i; ?></label>
                                    </div>
                                <?php endforeach; ?>
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <?php foreach (range(0,3) as $i): ?>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="balconies" id="balconies<?php echo $i; ?>" value="<?php echo $i; ?>">
                                    <label class="form-check-label" for="balconies<?php echo $i; ?>"><?php echo $i; ?></label>
                                </div>
                            <?php endforeach; ?>
                            </div>
                        </div>
                ...
                <!-- Step 3: Price & Features -->
                 <div class="repm-step repm-card" data-step="3" style="display:none;">
                    ...
                    <div class="mb-3">
                        ...
                        <?php $furn_det = ['Wardrobe','Modular Kitchen']; foreach($furn_det as $i=>$val): ?>
                            <div class="form-check form-check-inline">
    ...
    <script>
    jQuery(function($){
        // Indian number formatting for price input in property submission form
        ...
        $priceInput.on('input', function() {
            ...
            // Allow: backspace (8), tab (9), enter (13), left/right arrows (37/39), delete (46)
            if (
            ...
            // Only allow pasting numbers (possibly with commas)
      ...
      function showStep(n) {
        ...
        // Remove ALL validation errors and highlights from the entire form
      ...
      // Conditional logic for property type fields and bedrooms/bathrooms/balconies
    ...
    if(selected === 'residential') {
        ...
        // Make bedrooms and bathrooms required
        ...
        // Remove required from bedrooms and bathrooms
        $('#residential-details-wrap input[name="bedrooms"], #residential-details-wrap input[name="bathrooms"]').removeAttr('required');
        // Clear values
        $('#residential-details-wrap input[name="bedrooms"], #residential-details-wrap input[name="bathrooms"]').prop('checked', false);
    } else {
      ...
      // Radio group validation that only highlights one error per group
      ...
      $(document).on('click', '.repm-next-btn', function(e){
        ...
        // Validate required (non-radio) fields
        var html5valid = true;
      ...
      // --- LIVE ERROR CLEARING (fix for error not clearing on input/select) ---
      $('#repm-property-form').on('input change', 'input, select, textarea', function() {
        var $el = $(this);
        // For radios, clear group if any is selected
        if ($el.is(':radio')) {
          ...
          // File input: check if a file is selected
    ...
    $('#property_images_input').on('change', function(e) {
        ...
        // Set hidden value to first image by default
