                ...
                <div class="row" style="gap:10px;">
                    <div class="col-md-12 repm-list-no-bullet">
                        ...
                        <ul class="list-group mb-2">
                            ...
                            <li class="list-group-item"><strong>For Sale/Rent:</strong> <?php echo esc_html(ucwords(strtolower(get_post_meta($post->ID, '_for_sale_rent', true)))); ?></li>
                            <li class="list-group-item"><strong>Type of Property:</strong> <?php echo esc_html(ucwords(strtolower(get_post_meta($post->ID, '_type_of_property', true)))); ?></li>
                            ...
                            <li class="list-group-item"><strong>Ownership:</strong> <?php echo esc_html(get_post_meta($post->ID, '_ownership', true)); ?></li>
